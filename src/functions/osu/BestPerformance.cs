...
namespace KanonBot.Functions.OSUBot
{
    public class BpCommand : ICommand
    {
        public CommandDef Definition =>
            ...
            {
                Name = "bp",
                Description = "Show an osu! best performance score",
                ...
                [
                    ...
                    new() { Name = "order_number", Description = "Score list position", Prefix = ArgPrefix.None, Strategy = ParseStrategy.Ambiguous, Parse = s => CommandDefs.ParseInt(s) },
